    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-1sdqior"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$1, 10, 2, 146);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*caption*/ 2) set_data_dev(t, /*caption*/ ctx[1]);

    			if (dirty[0] & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-1sdqior"))) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1kfg5ct");
    			add_location(h1, file$2, 14, 4, 243);
    			attr_dev(h2, "class", "svelte-1kfg5ct");
    			add_location(h2, file$2, 15, 4, 264);
    			attr_dev(p0, "class", "svelte-1kfg5ct");
    			add_location(p0, file$2, 16, 4, 288);
    			attr_dev(header, "class", "svelte-1kfg5ct");
    			add_location(header, file$2, 13, 2, 230);
    			if (img.src !== (img_src_value = /*imageUrl*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*title*/ ctx[0]);
    			attr_dev(img, "class", "svelte-1kfg5ct");
    			add_location(img, file$2, 19, 4, 343);
    			attr_dev(div0, "class", "image svelte-1kfg5ct");
    			add_location(div0, file$2, 18, 2, 319);
    			attr_dev(p1, "class", "svelte-1kfg5ct");
    			add_location(p1, file$2, 22, 4, 417);
    			attr_dev(div1, "class", "content svelte-1kfg5ct");
    			add_location(div1, file$2, 21, 2, 391);
    			attr_dev(footer, "class", "svelte-1kfg5ct");
    			add_location(footer, file$2, 24, 2, 449);
    			attr_dev(article, "class", "svelte-1kfg5ct");
    			add_location(article, file$2, 12, 0, 218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*subtitle*/ 2) set_data_dev(t2, /*subtitle*/ ctx[1]);
    			if (!current || dirty[0] & /*address*/ 16) set_data_dev(t4, /*address*/ ctx[4]);

    			if (!current || dirty[0] & /*imageUrl*/ 4 && img.src !== (img_src_value = /*imageUrl*/ ctx[2])) {
    			...
    			if (!current || dirty[0] & /*description*/ 8) set_data_dev(t7, /*description*/ ctx[3]);
    			const button0_changes = {};
    			if (dirty[0] & /*contact*/ 32) button0_changes.href = "mailto:" + /*contact*/ ctx[5];
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 24, 2, 647);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 12, 2, 239);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$4, 10, 2, 170);
    			attr_dev(div, "class", "from-control");
    			add_location(div, file$4, 9, 0, 141);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$5, 53, 2, 1452);
    			attr_dev(main, "class", "svelte-14fgpj0");
    			add_location(main, file$5, 52, 0, 1443);
