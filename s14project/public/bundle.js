...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 48, 2, 1160);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 50, 4, 1200);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$hobbyStore*/ 4 && t_value !== (t_value = /*hobby*/ ctx[5] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:2) {#each $hobbyStore as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 38, 0, 973);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "hobby");
    			add_location(input, file, 39, 0, 1006);
    			add_location(button, file, 43, 0, 1066);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $hobbyStore;
    	validate_store(hobbyStore, "hobbyStore");
    	component_subscribe($$self, hobbyStore, $$value => $$invalidate(2, $hobbyStore = $$value));
    	let hobbyInput;
    	let isLoading = false;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("$hobbyStore" in $$props) hobbyStore.set($hobbyStore = $$props.$hobbyStore);
    	};
