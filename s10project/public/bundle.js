...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => {
    		return { title, price, id, showDescription };
    	};
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 30, 6, 533);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (28:4) {#each items as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:4) {#each items as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 25, 2, 388);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 26, 2, 404);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 24, 0, 376);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (59:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(59:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 53, 4, 835);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$3, 54, 4, 856);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$3, 55, 4, 877);
    			add_location(div0, file$3, 52, 2, 825);
    			add_location(div1, file$3, 57, 2, 909);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$3, 51, 0, 801);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
