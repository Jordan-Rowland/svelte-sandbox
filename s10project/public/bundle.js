...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 61, 4, 1449);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 54, 2, 1191);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$1, 55, 2, 1210);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$1, 53, 0, 1184);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function displayDescription() {
    		...
    		const prodSubscription = products.subscribe(products => {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 63, 6, 1619);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 58, 2, 1469);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 59, 2, 1485);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 57, 0, 1457);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("$cartItems" in $$props) cart.set($cartItems = $$props.$cartItems);
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 27, 4, 430);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$3, 28, 4, 451);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$3, 29, 4, 472);
    			add_location(div0, file$3, 26, 2, 420);
    			add_location(div1, file$3, 31, 2, 504);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$3, 25, 0, 396);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
